...
namespace Dms\Cli\Expressive\Tests\Integration\Scaffold;
...
class ScaffoldCmsTest extends ScaffoldTest
{
    ...
    public function testScaffold(string $name, string $entityNamespace, string $domainPath, string $cmsPath)
    {
        ...
        $this->getConsole()->call('dms:scaffold:cms', [
            ...
            'data_source_namespace' => 'Dms\Cli\Expressive\Tests\Integration\Scaffold\Fixture\\' . $name . '\Persistence\Services',
        ]);
    ...
    public function testFilterOption(string $filter, $shouldExist)
    {
        ...
        $this->getConsole()->call('dms:scaffold:cms', [
            ...
            'data_source_namespace' => 'Dms\Cli\Expressive\Tests\Integration\Scaffold\Fixture\Simple\Persistence\Services',
            '--filter'              => $filter,
        ]);
